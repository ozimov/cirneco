...
public class IsPositiveTest extends BaseMatcherTest {
    ...
    public void testGivenPositiveNumberWhenMatchesIsCalledThenTrueIsReturned() throws Exception {
        ...
        final boolean isBigDecimalAPositiveValue = isPositiveMatcher.matches(new BigDecimal(100D));
    ...
    public void testGivenNegativeNumberWhenMatchesIsCalledThenFalseIsReturned() throws Exception {
        ...
        final boolean isBigDecimalAPositiveValue = isPositiveMatcher.matches(new BigDecimal(-100.0D));
    ...
    public void testGivenZeroNumberWhenMatchesIsCalledThenFalseIsReturned() throws Exception {
        ...
        final boolean isBigDecimalAPositiveValue = isPositiveMatcher.matches(new BigDecimal(.0D));
    ...
    public void testDescribeMismatchSafely() throws Exception {
        assertHasMismatchDescription("<0> is not positive",
                isPositiveMatcher, (byte) 0);
        assertHasMismatchDescription("<0s> is not positive",
                isPositiveMatcher, (short) 0);
        assertHasMismatchDescription("<0> is not positive",
                isPositiveMatcher, 0);
        assertHasMismatchDescription("<0L> is not positive",
                isPositiveMatcher, 0L);
        assertHasMismatchDescription("<0> is not positive",
                isPositiveMatcher, new BigInteger("0"));
        assertHasMismatchDescription("<0> is not positive",
                isPositiveMatcher, new AtomicInteger(0));
        assertHasMismatchDescription("<0> is not positive",
                isPositiveMatcher, new AtomicLong(0L));

        assertHasMismatchDescription("<0.0F> is not positive",
                isPositiveMatcher, .0F);
        assertHasMismatchDescription("<0.0> is not positive",
                isPositiveMatcher, .0D);
        assertHasMismatchDescription("<0.0> is not positive",
                isPositiveMatcher, new BigDecimal(".0"));
    }
