...
- Package is now in the form `it.ozimov.cirneco.it.ozimov.cirneco.hamcrest.$MODULE$`,
  where `$MODULE$` is `guava`, `java7` or `java8`, respectively for Google Guava, JDK7 and JDK8 matchers.
- Classes in packages `it.ozimov.cirneco.it.ozimov.cirneco.hamcrest.iterable` and
  `it.ozimov.cirneco.it.ozimov.cirneco.hamcrest.map` are now in package
  `it.ozimov.cirneco.it.ozimov.cirneco.hamcrest.$MODULE$.collect`, where `$MODULE$` is `guava` or `java7`
...
## [0.2] - 2016-01-04
### Added
- New matcher in package `it.ozimov.cirneco.it.ozimov.cirneco.hamcrest.iterable`, i.e. `IsIterableWithDistinctElements`
- New matcher in package `it.ozimov.cirneco.it.ozimov.cirneco.hamcrest.date`, i.e. `IsDateWithInWeekOfYear`
- New matchers in package `it.ozimov.cirneco.it.ozimov.cirneco.hamcrest.number`, i.e. `IsPositive` and  `IsNegative`
...
## [0.1] - 2015-12-30
### Added
- New matchers in package `it.ozimov.cirneco.it.ozimov.cirneco.hamcrest.base`:
