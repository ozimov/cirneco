...
public class IsMultisetElementWithCountTest extends BaseMatcherTest {
    ...
    @Before public void setUp() {
        ...
        isMultisetElementWithCountMatcher = IsMultisetElementWithCount
            .elementWithCount(comparison, expectedCountGeneralMatcher);
    }
    ...
    @Test public void testGivenAMultisetWithElementWithCountTenWhenMatchesForCountTenIsCalledThenTrueIsReturned()
        throws Exception {
        ...
        //Act
        final boolean matches = isMultisetElementWithCountMatcher.matches(
                multiset);
    ...
    @Test public void testGivenAMultisetWithElementWithCountOneWhenMatchesForCountTenIsCalledThenFalseIsReturned()
        throws Exception {
    ...
    @Test public void testDescribeMismatchSafely() throws Exception {
        BaseMatcherTest.assertHasMismatchDescription(String.format(
                "Multiset had element \"%s\" with count <0>", comparison),
    ...
    @Test public void testDescribeTo() throws Exception {
        BaseMatcherTest.assertIsDescribedTo(String.format(
                "a Multiset with element \"%s\" with count <%d>", comparison,
