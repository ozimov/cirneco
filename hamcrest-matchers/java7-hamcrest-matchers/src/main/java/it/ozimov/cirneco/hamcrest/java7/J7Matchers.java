...
/**
 * The {@code J7Matchers} class groups all the matchers
...
public class J7Matchers {
     ...
     */
    public static <T extends Comparable<T>> Matcher<T> between(final T from,
        final T to) {
     ...
     */
    public static <T extends Comparable<T>> Matcher<T> betweenInclusive(
     ...
     * will return <code>false</code>.
     */
    public static <T extends Comparable<T>> Matcher<T> betweenLowerBoundInclusive(
        final T from, final T to) {
        return IsBetweenLowerBoundInclusive.betweenLowerBoundInclusive(from,
                to);
    }
     ...
     * will return <code>false</code>.
     */
    public static <T extends Comparable<T>> Matcher<T> betweenUpperBoundInclusive(
        final T from, final T to) {
        return IsBetweenUpperBoundInclusive.betweenUpperBoundInclusive(from,
                to);
    }
     ...
     */
    public static <T extends Comparable<T>> Matcher<T> afterOrEqual(
        final T value) {
     ...
     */
    public static <T extends Comparable<T>> Matcher<T> beforeOrEqual(
        final T value) {
     ...
     */
    public static Matcher<Date> hasHourAndMin(final int hour,
        final int minute) {
     ...
     */
    public static Matcher<Date> hasHourAndMin(final int hour,
        final ClockPeriod clockPeriod, final int minute) {
     ...
     */
    public static Matcher<Date> hasHourMinAndSec(final Integer hour,
        final ClockPeriod clockPeriod, final Integer minute,
        final Integer second) {
        return IsDateWithTime.hasHourMinAndSec(hour, clockPeriod, minute,
                second);
    }
    ...
    public static Matcher<Date> hasHourMinSecAndMillis(final Integer hour,
        ...
        return IsDateWithTime.hasHourMinSecAndMillis(hour, minute, second,
                millisecond);
    }
    ...
    public static Matcher<Date> hasHourMinSecAndMillis(final Integer hour,
        final ClockPeriod clockPeriod, final Integer minute,
        final Integer second, final Integer millisecond) {
        return IsDateWithTime.hasHourMinSecAndMillis(hour, clockPeriod, minute,
                second, millisecond);
    }
     ...
     */
    public static <K> Matcher<Map<? extends K, ?>> hasSameKeySet(
        final Map<? extends K, ?> comparisonMap) {
