...
public class IsDateWithTime extends TypeSafeMatcher<Date> {
    ...
    public IsDateWithTime(final Integer hour, final Integer min,
        final Integer sec, final Integer millis) {
     ...
     */
    public static Matcher<Date> hasHourMinAndSec(final int hour,
        final ClockPeriod clockPeriod, final int minute, final int second) {
    ...
    public static Matcher<Date> hasHourMinSecAndMillis(final int hour,
        ...
        return new IsDateWithTime(hour, clockPeriod, minute, second,
                millisecond);
    }
    ...
    @Override protected boolean matchesSafely(final Date date) {
        ...
        if (hour != null) {
            ...
            case AM:
                matches = (hour == CalendarUtils.hour12(date)) &&
                    CalendarUtils.isAM(date);

                break;

            case PM:
                matches = (hour == CalendarUtils.hour12(date)) &&
                    CalendarUtils.isPM(date);
