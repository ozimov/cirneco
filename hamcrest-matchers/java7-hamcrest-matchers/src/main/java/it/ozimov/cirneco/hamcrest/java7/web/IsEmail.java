 ...
 * user@[IPv6:2001:db8::1]</code> would be invalid, while they are absolutely valid). Please, refer to Apache Commons
 * documentation for <code>EmailValidator</code> for more details.
 *
