...
public class IsBetweenUpperBoundInclusiveTest extends BaseMatcherTest {
    ...
    @Before public void setUp() {
        ...
        final Integer to = 12;
        isBetweenUpperBoundInclusiveMatcher = IsBetweenUpperBoundInclusive
            .betweenUpperBoundInclusive(from, to);
    }
    ...
    @Test public void testDescribeMismatchSafely() throws Exception {
        assertHasMismatchDescription(
            "<9> is not between <10> excluded and <12> included",
            isBetweenUpperBoundInclusiveMatcher, 9);
        assertHasMismatchDescription(
            "<10> is not between <10> excluded and <12> included",
            isBetweenUpperBoundInclusiveMatcher, 10);
    }

    @Test public void testDescribeTo() throws Exception {
        assertIsDescribedTo("a value between <10> excluded and <12> included",
            isBetweenUpperBoundInclusiveMatcher);
    }
    ...
    @Test public void testGivenNumberEqualsToLowerBoundWhenMatchesIsCalledThenReturnFalse()
        ...
        //Act
        final boolean isBetweenUpperBoundInclusive =
            isBetweenUpperBoundInclusiveMatcher.matches(10);
    ...
    @Test public void testGivenNumberBetweenWhenMatchesIsCalledThenReturnTrue()
        ...
        //Act
        final boolean isBetweenUpperBoundInclusive =
            isBetweenUpperBoundInclusiveMatcher.matches(11);
    ...
    @Test public void testGivenNumberEqualsToUpperBoundWhenMatchesIsCalledThenReturnTrue()
        ...
        //Act
        final boolean isBetweenUpperBoundInclusive =
            isBetweenUpperBoundInclusiveMatcher.matches(12);

        //Assert
        assertThat(isBetweenUpperBoundInclusive, is(true));
    }

    @Test public void testGivenNumberBiggerThanLowerBoundWhenMatchesIsCalledThenReturnTrue()
        throws Exception {

        //Act
        final boolean isBetweenUpperBoundInclusive =
            isBetweenUpperBoundInclusiveMatcher.matches(13);
