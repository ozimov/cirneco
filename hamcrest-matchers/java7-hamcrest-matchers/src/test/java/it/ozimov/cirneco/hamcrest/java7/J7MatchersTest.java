...
public class J7MatchersTest {
    ...
    @Test public void testHasYearAndMonth() throws Exception {
        assertThat(J7Matchers.hasYearAndMonth(2015, 12),
            instanceOf(IsDate.class));
    }

    @Test public void testHasYearMonthAndDay() throws Exception {
        assertThat(J7Matchers.hasYearMonthAndDay(2015, 12, 22),
            instanceOf(IsDate.class));
    }
    ...
    @Test public void testHasHourWithClockPeriod() throws Exception {
        assertThat(J7Matchers.hasHour(11, AM),
    ...
    @Test public void testHasDistinctElements() throws Exception {
        assertThat(J7Matchers.hasDistinctElements(),
    ...
    @Test public void testHasSize() throws Exception {
        ...
        //Act
        final Matcher<Iterable<Object>> matcher = J7Matchers.hasSize(
                expectedSize);
        final boolean hasExpectedSize = matcher.matches(
                iterableWithExpectedSize);
    ...
    @Test public void testNegativeInfinity() throws Exception {
        assertThat(J7Matchers.negativeInfinity(),
    ...
    @Test public void testPositiveInfinity() throws Exception {
        assertThat(J7Matchers.positiveInfinity(),
