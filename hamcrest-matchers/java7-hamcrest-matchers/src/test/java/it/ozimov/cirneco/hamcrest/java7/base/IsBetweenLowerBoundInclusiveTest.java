...
public class IsBetweenLowerBoundInclusiveTest extends BaseMatcherTest {
    ...
    @Before public void setUp() {
        ...
        final Integer to = 12;
        isBetweenLowerBoundInclusiveMatcher = IsBetweenLowerBoundInclusive
            .betweenLowerBoundInclusive(from, to);
    }
    ...
    @Test public void testDescribeMismatchSafely() throws Exception {
        assertHasMismatchDescription(
            "<9> is not between <10> included and <12> excluded",
            isBetweenLowerBoundInclusiveMatcher, 9);
        assertHasMismatchDescription(
            "<12> is not between <10> included and <12> excluded",
            isBetweenLowerBoundInclusiveMatcher, 12);
        assertHasMismatchDescription(
            "<13> is not between <10> included and <12> excluded",
            isBetweenLowerBoundInclusiveMatcher, 13);
    }

    @Test public void testDescribeTo() throws Exception {
        assertIsDescribedTo("a value between <10> included and <12> excluded",
            isBetweenLowerBoundInclusiveMatcher);
    }

    @Test public void testGivenNumberSmallerThanLowerBoundWhenMatchesIsCalledThenReturnTrue()
        throws Exception {

        //Act
        final boolean isBetweenLowerBoundInclusive =
            isBetweenLowerBoundInclusiveMatcher.matches(9);

        //Assert
        assertThat(isBetweenLowerBoundInclusive, is(false));
    }

    @Test public void testGivenNumberEqualsToLowerBoundWhenMatchesIsCalledThenReturnTrue()
        throws Exception {

        //Act
        final boolean isBetweenLowerBoundInclusive =
            isBetweenLowerBoundInclusiveMatcher.matches(10);
    ...
    @Test public void testGivenNumberBetweenWhenMatchesIsCalledThenReturnTrue()
        ...
        //Act
        final boolean isBetweenLowerBoundInclusive =
            isBetweenLowerBoundInclusiveMatcher.matches(11);

        //Assert
        assertThat(isBetweenLowerBoundInclusive, is(true));
    }

    @Test public void testGivenNumberEqualsToUpperBoundWhenMatchesIsCalledThenReturnTrue()
        throws Exception {

        //Act
        final boolean isBetweenLowerBoundInclusive =
            isBetweenLowerBoundInclusiveMatcher.matches(12);
