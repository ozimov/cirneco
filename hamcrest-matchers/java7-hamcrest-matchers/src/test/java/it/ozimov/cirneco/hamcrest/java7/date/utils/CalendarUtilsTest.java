...
public class CalendarUtilsTest {
    ...
    @Test public void testFromDateToCalendar() throws Exception {

        //Arrange
        final Date date = new DateTime(2015, 12, 21, 10, 0, 59, 999,
                BaseDateMatcherTest.TIME_ZONE).toDate();
        ...
        //Assert
        assertThat(
            "Expected that the Calendar has the same timestamp than the date",
            calendar.getTimeInMillis(), is(date.getTime()));
    }

    @Test public void testWeekDay() throws Exception {

        //Arrange
        final Date mondayDate = new DateTime(2015, 12, 21, 0, 0, 0,
                BaseDateMatcherTest.TIME_ZONE).toDate();
        final Date fridayDate = new DateTime(2015, 12, 25, 0, 0, 0,
                BaseDateMatcherTest.TIME_ZONE).toDate();
        final Date nextMondayDate = new DateTime(2015, 12, 28, 0, 0, 0,
                BaseDateMatcherTest.TIME_ZONE).toDate();
    ...
    @Test public void testMonth() throws Exception {
        ...
        //Arrange
        final Date februaryDate = new DateTime(2015, 2, 21, 0, 0, 0,
                BaseDateMatcherTest.TIME_ZONE).toDate();
        final Date decemberDate = new DateTime(2015, 12, 21, 0, 0, 0,
                BaseDateMatcherTest.TIME_ZONE).toDate();
    ...
    @Test public void testWeekOfYear() throws Exception {

        //Arrange
        final Date week1Date = new DateTime(2014, 12, 29, 0, 0, 0,
                BaseDateMatcherTest.TIME_ZONE).toDate();
        final Date week2Date = new DateTime(2015, 1, 5, 0, 0, 0,
                BaseDateMatcherTest.TIME_ZONE).toDate();
        final Date week52Date = new DateTime(2015, 12, 27, 0, 0, 0,
                BaseDateMatcherTest.TIME_ZONE).toDate();
        final Date week53Date = new DateTime(2016, 1, 3, 0, 0, 0,
                BaseDateMatcherTest.TIME_ZONE).toDate();
    ...
    @Test public void testDay() throws Exception {

        //Arrange
        final Date day1Date = new DateTime(2015, 1, 31, 0, 0, 0,
                BaseDateMatcherTest.TIME_ZONE).toDate();
        final Date day2Date = new DateTime(2000, 2, 29, 0, 0, 0,
                BaseDateMatcherTest.TIME_ZONE).toDate();
    ...
    @Test public void testDayOfYear() throws Exception {
        ...
        final Date day2Date = new DateTime(2000, 2, 29, 0, 0, 0,
                BaseDateMatcherTest.TIME_ZONE).toDate();
        final Date day3Date = new DateTime(2000, 3, 1, 0, 0, 0,
                BaseDateMatcherTest.TIME_ZONE).toDate();
    ...
    @Test public void testYear() throws Exception {
        ...
        //Arrange
        final Date year1Date = new DateTime(2015, 1, 1, 1, 0, 0, 0,
                BaseDateMatcherTest.TIME_ZONE).toDate();
        final Date year2Date = new DateTime(2000, 1, 1, 1, 0, 0, 0,
                BaseDateMatcherTest.TIME_ZONE).toDate();
    ...
    @Test public void testIsLeapYear() throws Exception {

        //Arrange
        final Date leapYearDate = new DateTime(2000, 1, 1, 1, 0, 0, 0,
                BaseDateMatcherTest.TIME_ZONE).toDate();
        final Date nonLeapYearDate = new DateTime(2001, 1, 1, 1, 0, 0, 0,
                BaseDateMatcherTest.TIME_ZONE).toDate();

        //Act
        final boolean is2000LeapYear = CalendarUtils.isLeapYear(leapYearDate);
        final boolean is2001LeapYear = CalendarUtils.isLeapYear(
                nonLeapYearDate);
    ...
    @Test public void testIsAM() throws Exception {

        //Arrange
        final Date amDate = new DateTime(2000, 1, 1, 11, 0, 0, 0,
                BaseDateMatcherTest.TIME_ZONE).toDate();
        final Date pmDate = new DateTime(2000, 1, 1, 23, 0, 0, 0,
                BaseDateMatcherTest.TIME_ZONE).toDate();
    ...
    @Test public void testIsPM() throws Exception {
    ...
    @Test public void testHour12() throws Exception {
    ...
    @Test public void testHour24() throws Exception {
    ...
    @Test public void testMinute() throws Exception {
        ...
        //Arrange
        final Date date = new DateTime(2000, 1, 1, 0, 30, 0, 0,
                BaseDateMatcherTest.TIME_ZONE).toDate();
    ...
    @Test public void testSecond() throws Exception {
        ...
        //Arrange
        final Date date = new DateTime(2000, 1, 1, 0, 0, 40, 0,
                BaseDateMatcherTest.TIME_ZONE).toDate();
    ...
    @Test public void testMillisecond() throws Exception {

        //Arrange
        final Date date = new DateTime(2000, 1, 1, 0, 0, 0, 999,
                BaseDateMatcherTest.TIME_ZONE).toDate();
