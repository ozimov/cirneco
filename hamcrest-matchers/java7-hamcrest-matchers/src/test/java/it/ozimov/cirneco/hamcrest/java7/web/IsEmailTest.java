...
public class IsEmailTest extends BaseMatcherTest {
    ...
    private static final Object[] VALID_EMAILS = {
            ...
            "perché@example.com", "あいうえお@example.com",
            "email@[123.123.123.123]", "\"email\"@example.com",
            "1234567890@example.com", "email@example-one.com",
            "email@example.name", "email@example.museum", "email@example.co.jp",
    ...
    @Test public void testGivenValidEmailAddressWhenMatchesIsCalledThenReturnTrue()
        throws Exception {
    ...
    @Test public void testGivenNonValidEmailAddressWhenMatchesIsCalledThenReturnFalse()
        throws Exception {
    ...
    @Test public void testDescribeMismatchSafely() throws Exception {
        ...
        for (final Object email : NON_VALID_EMAILS) {
            assertHasMismatchDescription(format(
                    "<%s> is not a valid email address", email), isEmailMatcher,
                email);
        }
    }

    @Test public void testDescribeTo() throws Exception {
        assertIsDescribedTo("a value equals to a valid email address",
            isEmailMatcher);
