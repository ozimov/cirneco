...
public class IsPositiveTest extends BaseMatcherTest {
    ...
    @Test public void testGivenPositiveInfiniteNumberWhenMatchesIsCalledThenTrueIsReturned()
        ...
        final boolean isFloatPositiveInfinityAPositiveValue =
            isPositiveMatcher.matches(Float.POSITIVE_INFINITY);
        final boolean isDoublePositiveInfinityAPositiveValue =
            isPositiveMatcher.matches(Double.POSITIVE_INFINITY);
    ...
    @Test public void testGivenPositiveNumberWhenMatchesIsCalledThenTrueIsReturned()
        throws Exception {

        //Act
        final boolean isByteAPositiveValue = isPositiveMatcher.matches((byte)
                100);
        final boolean isShortAPositiveValue = isPositiveMatcher.matches((short)
                100);
        ...
        final boolean isAtomicIntegerAPositiveValue = isPositiveMatcher.matches(
                new AtomicInteger(100));
        final boolean isAtomicLongAPositiveValue = isPositiveMatcher.matches(
                new AtomicLong(100L));
        final boolean isBigIntegerAPositiveValue = isPositiveMatcher.matches(
                new BigInteger("100"));
        ...
        final boolean isBigDecimalAPositiveValue = isPositiveMatcher.matches(
    ...
    @Test public void testGivenNegativeNumberWhenMatchesIsCalledThenFalseIsReturned()
        throws Exception {
        ...
        final boolean isFloatAPositiveValue = isPositiveMatcher.matches(
                -100.0f);
        final boolean isDoubleAPositiveValue = isPositiveMatcher.matches(
                -100.0D);
        final boolean isBigDecimalAPositiveValue = isPositiveMatcher.matches(
                new BigDecimal("-100.0"));
    ...
    @Test public void testDescribeMismatchSafely() throws Exception {
        assertHasMismatchDescription("<0> is not positive", isPositiveMatcher,
            (byte) 0);
        assertHasMismatchDescription("<0s> is not positive", isPositiveMatcher,
            (short) 0);
        assertHasMismatchDescription("<0> is not positive", isPositiveMatcher,
            0);
        assertHasMismatchDescription("<0L> is not positive", isPositiveMatcher,
            0L);
        assertHasMismatchDescription("<0> is not positive", isPositiveMatcher,
            new BigInteger("0"));
        assertHasMismatchDescription("<0> is not positive", isPositiveMatcher,
        ...
        assertHasMismatchDescription("<0.0F> is not positive",
            isPositiveMatcher, .0F);
        assertHasMismatchDescription("<0.0> is not positive", isPositiveMatcher,
            .0D);
        assertHasMismatchDescription("<0.0> is not positive", isPositiveMatcher,
            new BigDecimal(".0"));
    }
