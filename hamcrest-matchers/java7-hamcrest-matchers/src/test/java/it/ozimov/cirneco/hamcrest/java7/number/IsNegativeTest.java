...
public class IsNegativeTest extends BaseMatcherTest {
    ...
    public void testGivenNegativeInfiniteNumberWhenMatchesIsCalledThenTrueIsReturned() throws Exception {
        ...
        // Act
        final boolean isFloatPositiveInfinityAPositiveValue = isNegativeMatcher.matches(Float.NEGATIVE_INFINITY);
        final boolean isDoublePositiveInfinityAPositiveValue = isNegativeMatcher.matches(Double.NEGATIVE_INFINITY);
    ...
    public void testGivenNegativeNumberWhenMatchesIsCalledThenTrueIsReturned() throws Exception {
        ...
        // Act
        final boolean isByteAPositiveValue = isNegativeMatcher.matches((byte) -100);
        final boolean isShortAPositiveValue = isNegativeMatcher.matches((short) -100);
        ...
        final boolean isAtomicIntegerAPositiveValue = isNegativeMatcher.matches(new AtomicInteger(-100));
        final boolean isAtomicLongAPositiveValue = isNegativeMatcher.matches(new AtomicLong(-100L));
        final boolean isBigIntegerAPositiveValue = isNegativeMatcher.matches(new BigInteger("-100"));
    ...
    public void testGivenZeroNumberWhenMatchesIsCalledThenFalseIsReturned() throws Exception {
        ...
        // Act
        final boolean isByteAPositiveValue = isNegativeMatcher.matches((byte) 0);
        final boolean isShortAPositiveValue = isNegativeMatcher.matches((short) 0);
        ...
        final boolean isAtomicIntegerAPositiveValue = isNegativeMatcher.matches(new AtomicInteger(0));
        final boolean isAtomicLongAPositiveValue = isNegativeMatcher.matches(new AtomicLong(0L));
        final boolean isBigIntegerAPositiveValue = isNegativeMatcher.matches(new BigInteger("0"));
    ...
    public void testDescribeMismatchSafely() throws Exception {
        assertHasMismatchDescription("<0> is not negative", isNegativeMatcher, (byte) 0);
        assertHasMismatchDescription("<0s> is not negative", isNegativeMatcher, (short) 0);
        assertHasMismatchDescription("<0> is not negative", isNegativeMatcher, 0);
        assertHasMismatchDescription("<0L> is not negative", isNegativeMatcher, 0L);
        assertHasMismatchDescription("<0> is not negative", isNegativeMatcher, new BigInteger("0"));
        assertHasMismatchDescription("<0> is not negative", isNegativeMatcher, new AtomicInteger(0));
        assertHasMismatchDescription("<0> is not negative", isNegativeMatcher, new AtomicLong(0L));

        assertHasMismatchDescription("<0.0F> is not negative", isNegativeMatcher, .0F);
        assertHasMismatchDescription("<0.0> is not negative", isNegativeMatcher, .0D);
        assertHasMismatchDescription("<0.0> is not negative", isNegativeMatcher, new BigDecimal(".0"));
    }
