...
public class IsBetweenInclusiveTest extends BaseMatcherTest {
    ...
    @Before public void setUp() {
        ...
        final Integer to = 12;
        isBetweenInclusiveMatcher = IsBetweenInclusive.betweenInclusive(from,
                to);
    }
    ...
    @Test public void testDescribeMismatchSafely() throws Exception {
        assertHasMismatchDescription(
            "<9> is not between <10> and <12>, both included",
            isBetweenInclusiveMatcher, 9);
        assertHasMismatchDescription(
            "<13> is not between <10> and <12>, both included",
            isBetweenInclusiveMatcher, 13);
    }

    @Test public void testDescribeTo() throws Exception {
        assertIsDescribedTo("a value between <10> and <12>, both included",
            isBetweenInclusiveMatcher);
    }
    ...
    @Test public void testGivenNumberEqualsToLowerBoundWhenMatchesIsCalledThenReturnTrue()
        ...
        //Act
        final boolean isBetweenInclusive = isBetweenInclusiveMatcher.matches(
                10);
