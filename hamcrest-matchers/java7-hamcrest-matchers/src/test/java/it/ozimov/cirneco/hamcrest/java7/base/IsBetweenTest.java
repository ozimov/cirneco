...
public class IsBetweenTest extends BaseMatcherTest {
    ...
    public void testDescribeMismatchSafely() throws Exception {
        assertHasMismatchDescription("<9> is not between <10> and <12>, both excluded", isBetweenMatcher, 9);
        assertHasMismatchDescription("<10> is not between <10> and <12>, both excluded", isBetweenMatcher, 10);
        assertHasMismatchDescription("<12> is not between <10> and <12>, both excluded", isBetweenMatcher, 12);
        assertHasMismatchDescription("<13> is not between <10> and <12>, both excluded", isBetweenMatcher, 13);
    }
