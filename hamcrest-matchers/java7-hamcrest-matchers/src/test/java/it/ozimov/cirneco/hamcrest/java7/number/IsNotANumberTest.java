...
public class IsNotANumberTest extends BaseMatcherTest {
    ...
    @Test public void testGivenInvalidNumberValueWhenMatchesIsCalledThenTrueIsReturned()
        throws Exception {

        //Act
        final boolean isFloatNotANumber = isNotANumberMatcher.matches(
                Float.NaN);
        final boolean isDoubleNotANumber = isNotANumberMatcher.matches(
                Double.NaN);
    ...
    @Test public void testGivenValidNumberValueWhenMatchesIsCalledThenFalseIsReturned()
        throws Exception {

        //Act
        final boolean isByteNotANumber = isNotANumberMatcher.matches((byte) 0);
        final boolean isShortNotANumber = isNotANumberMatcher.matches((short)
                0);
        ...
        final boolean isBigIntegerNotANumber = isNotANumberMatcher.matches(
                new BigInteger("0"));
        final boolean isAtomicIntegerNotANumber = isNotANumberMatcher.matches(
                new AtomicInteger(0));
        final boolean isAtomicLongNotANumber = isNotANumberMatcher.matches(
                new AtomicLong(0L));

        final boolean isFloatNotANumber = isNotANumberMatcher.matches((float)
                .0);
        final boolean isDoubleNotANumber = isNotANumberMatcher.matches(.0D);
        final boolean isBigDecimalNotANumber = isNotANumberMatcher.matches(
                new BigDecimal(".0"));
    ...
    @Test public void testDescribeMismatchSafely() throws Exception {
        assertHasMismatchDescription(
            "<0> is not a number (i.e. Double.NaN or Float.NaN)",
            isNotANumberMatcher, (byte) 0);
        assertHasMismatchDescription(
            "<0s> is not a number (i.e. Double.NaN or Float.NaN)",
            isNotANumberMatcher, (short) 0);
        assertHasMismatchDescription(
            "<0> is not a number (i.e. Double.NaN or Float.NaN)",
            isNotANumberMatcher, 0);
        assertHasMismatchDescription(
            "<0L> is not a number (i.e. Double.NaN or Float.NaN)",
        ...
        assertHasMismatchDescription(
            "<0.0F> is not a number (i.e. Double.NaN or Float.NaN)",
            isNotANumberMatcher, .0F);
        assertHasMismatchDescription(
            "<0.0> is not a number (i.e. Double.NaN or Float.NaN)",
    ...
    @Test public void testDescribeTo() throws Exception {
        assertIsDescribedTo("not a number (i.e. Double.NaN or Float.NaN)",
            isNotANumberMatcher);
    }
