...
public class IsMapWithSameKeySetTest extends BaseMatcherTest {
    ...
    @Before public void setUp() {
        ...
        //Arrange
        comparisonMap = ImmutableMap.of(1, "1", 2, "2", 3, "3", 4, "4");

        isMapWithSameKeySetMatcher = IsMapWithSameKeySet.hasSameKeySet(
                comparisonMap);
    }

    @Test public void testDescribeMismatchSafely() throws Exception {
        assertHasMismatchDescription("was null", isMapWithSameKeySetMatcher,
            null);
        assertHasMismatchDescription(
            "map key set was [] while expected key set was [<1=1>, <2=2>, <3=3>, <4=4>]",
            isMapWithSameKeySetMatcher, ImmutableMap.<Integer, Object>of());
    }

    @Test public void testDescribeTo() throws Exception {
        assertIsDescribedTo(
            "map containing same key set as [<1=1>, <2=2>, <3=3>, <4=4>]",
            isMapWithSameKeySetMatcher);
    }

    @Test public void testGivenTwoEqualsKeySetWhenMatchesIsCalledThenTrueIsReturned()
        throws Exception {
    ...
    @Test public void testGivenTwoDifferentKeySetWhenMatchesIsCalledThenFalseIsReturned()
        throws Exception {
