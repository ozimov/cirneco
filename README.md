...
**Latest Artifacts:** *it.ozimov:java7-hamcrest-matchers:jar:1.0.1*,
  *it.ozimov:java8-hamcrest-matchers:jar:1.0.1*,
  *it.ozimov:guava-hamcrest-matchers:jar:1.0.1* <br />
...
The current version (*Cirneco 1.0.1*) only provides some extensions for Hamcrest for Java.
