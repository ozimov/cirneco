...
**Latest Release:** *1.3.0*<br />
**Latest Artifacts:** *it.ozimov:java7-hamcrest-matchers:jar:1.3.0*,
  *it.ozimov:java8-hamcrest-matchers:jar:1.3.0*,
  *it.ozimov:guava-hamcrest-matchers:jar:1.3.0*,
  *it.ozimov:mockito-helpers:jar:1.3.0*<br />
...
The current version (*Cirneco 1.3.0*) only provides some extensions for Hamcrest for Java.
