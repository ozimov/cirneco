...
**Latest Artifacts:** *it.ozimov:java7-hamcrest-matchers:jar:1.0.0*,
  *it.ozimov:java8-hamcrest-matchers:jar:1.0.0*,
  *it.ozimov:guava-hamcrest-matchers:jar:1.0.0* <br />
...
The current version (*Cirneco 1.0.0*) only provides some extensions for Hamcrest for Java.
