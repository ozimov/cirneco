...
import org.cirneco.assertions.hamcrest.date.utils.CalendarUtils;
...
public class IsDate extends TypeSafeMatcher<Date> {
    ...
    public IsDate(final Integer year, final Integer month, final Integer day) {
        ...
        checkArgument(month == null || (month >= 1 && month <= 12), "The value id must be null or a number between 1 and 12");
    ...
    private boolean isDayValidForMonthAndYear(Integer year, Integer month, Integer day) {
        if (month != null) {
