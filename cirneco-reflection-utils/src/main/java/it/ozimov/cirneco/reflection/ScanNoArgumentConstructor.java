...
/**
 * Scan for a no-argument constructor
 *
 * @since version 0.6.0 for JDK7
 */
public class ScanNoArgumentConstructor {

    private static final Set<String> RESERVED_KEYWORDS = initReservedKeywords();

    @NoArgumentConstructor
    private ScanNoArgumentConstructor() {

    }

    public static Optional<Constructor> getNoArgumentConstructor(@Nonnull final Class clazz) {
        checkNotNull(clazz);
        ...
        final Set<Constructor> constructors = reflections.getConstructorsAnnotatedWith(NoArgumentConstructor.class);
    ...
    public static Set<Constructor> getAllNoArgumentConstructors(@Nonnull final String aPackage) {
